  ...
  return (
    <div className="w-full min-h-screen bg-[#F3F4FF] px-6 py-24 relative">
      ...
      <div className="relative flex flex-col items-center">
        <button
          className="absolute left-0 top-1/2 transform -translate-y-1/2 text-purple-600 hover:text-purple-800 transition-colors"
        ...
        <button
          className="absolute right-0 top-1/2 transform -translate-y-1/2 text-purple-600 hover:text-purple-800 transition-colors"
