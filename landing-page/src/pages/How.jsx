...
const How = () => {
  return (
    <div>
      <div className="bg-[#F3F4FF] text-center text-black px-4 pt-28">
      ...
      <div className="flex flex-col gap-16 md:gap-0 md:flex-row py-20 bg-[#F3F4FF]">
        ...
        <div className="flex flex-1 gap-8 flex-col ">
          <HowCard
            description="Join Eventio by signing up to unlock access to exclusive events.
          Complete the sign-up process to get started and enjoy a personalized
          experience tailored to your preferences."
            title="Sign up"
            img="https://res.cloudinary.com/dltnxkfrn/image/upload/v1726776172/Group_signUp_nlgyxu.png"
          />
          <HowCard
            description="Customize your Eventio experience by creating your profile and adding 
your event preferences. Tell us what you love, and we’ll recommend events
tailored just for you!"
          ...
          />
          <HowCard
            description="Explore exciting events happening! Use Eventio to find nearby
events that match your interests and make the most of what's happening
around you"
            title="Discover Events Near You"
            img="https://res.cloudinary.com/dltnxkfrn/image/upload/v1726776172/Group_Discover_mrbthy.png"
          />
          <HowCard
            description="Easily secure your spot at the hottest events with Eventio. Browse, choose
your tickets, and book in just a few clicks."
