    ...
    <div className="bg-[#F3F4FF] font-poppins text-gray-800">
      ...
      <section className="bg-white py-12 min-h-screen flex items-center">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between lg:gap-4">
          ...
          <div className="lg:w-1/2 lg:ml-14 flex flex-col items-start px-6 lg:px-0"> {/* Added px-4 for mobile padding */}
            ...
            <p className="font-bold lg:w-4/5 text-lg lg:text-xl mb-5"> {/* Added margin bottom for spacing */}
          ...
          <div className="lg:w-1/2 flex justify-center mb-14 pr-14 items-center mt-1 lg:mt-0">
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
              <div className="w-64 h-64 bg-[#E1DCFF] rounded-3xl shadow-lg border-2 border-gray p-4 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <img src={appleIcon} alt="Apple Icon" className="w-16 h-16" />
                </div>
              </div>
              <div className="w-64 h-64 bg-[#E1DCFF] rounded-3xl shadow-lg border-2 border-gray p-4 flex flex-col justify-between">
                <div>
                ...
                <div className="flex items-center justify-between">
                  {/* Use imported images */}
                  <img src={qrCode} alt="QR Code" className="w-16 h-16" />
                  <img src={androidIcon} alt="Android Icon" className="w-16 h-16" />
                </div>
              </div>
            </div>
          </div>
