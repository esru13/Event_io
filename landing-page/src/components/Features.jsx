...
const Features = () => {
  ...
  return (
    <div className="py-40 bg-[#F3F4FF] text-center text-white">
      <div className="flex flex-col w-full h-[500px] bg-gradient-to-br bg-black pl-3 md:pl-20 lg:pl-16 pt-16">
        <div className="flex flex-col w-fit justify-left">
          <h1 className="text-lg font-bold text-white text-left pl-5 mb-5">
            Best Features
          </h1>
          <h1 className="font-bold text-[#5516DA]  text-left text-3xl mb-1">
            Key Features of Our
          </h1>
...
const Card = ({ title1, title2, description, img, position }) => {
  return (
    <div className="w-[350px] h-[597px] flex-shrink-0 rounded-[28px] bg-white flex justify-center items-center flex-col p-5 hover:scale-105 cursor-pointer transition-all duration-300">
